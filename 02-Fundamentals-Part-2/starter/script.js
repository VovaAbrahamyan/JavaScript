...
// const farinheitToCelsius = (far) => {
//   return ((far - 32) * 5) / 9;
// };

// console.log(farinheitToCelsius(98));
...
if (jonas[interestedIn]) {
  ...
  console.log("Choose bettween firstName, lastName, age, job, and friends");
}
...
const jonas = {
  ...
  getSummary: function () {
    return `${this.firstName} is a ${this.calcAge()}-year old ${
      this.job
    }, and he has ${this.hasDriversLocense ? "a" : "no"} driver's license.`;
  },
};
